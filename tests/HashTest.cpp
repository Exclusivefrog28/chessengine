...
TEST_CASE("Initial Code", "[HashTests]") {
...
TEST_CASE("Capturing a piece", "[HashTests]") {
	ChessBoard board = ChessBoard();
	const HashCodes codes = board.hashCodes;
	board.setPosition("4k3/8/8/3p4/4P3/8/8/4K3 w - - 0 1");
...
TEST_CASE("Losing one castling right", "[HashTests]") {
	ChessBoard board = ChessBoard();
	const HashCodes codes = board.hashCodes;
...
TEST_CASE("Losing two castling rights", "[HashTests]") {
	ChessBoard board = ChessBoard();
	const HashCodes codes = board.hashCodes;
	board.setPosition("4k3/8/8/3p4/4P3/8/8/R3K2R w KQ - 0 1");
	const uint64_t originalCode = board.hashCode;
...
TEST_CASE("En passant", "[HashTests]") {
	ChessBoard board = ChessBoard();
	const HashCodes codes = board.hashCodes;
